...
RESULT_DIR = r"E:\月球_dataset\output\result56"  # R13结果

# 测试集 GT mask 目录 (一般不用改, 自动搜索)
TEST_MASK_DIR = r"E:\月球_dataset\dataset\datasetv5_random811\test\mask"

# 测试集影像目录 (可选, 用于显示 WAC/DEM/Slope)
TEST_IMG_DIR = r"E:\月球_dataset\dataset\datasetv5_random811\test\image"

# ========== TTA 配置 ==========
TTA_ENABLED = True                # 设为 True 启用 TTA 推理
MODEL_PATH = r"E:\月球_dataset\output\result56\best_small.pth"   # best_small.pth 路径
MODEL_SIZE = 'small'
